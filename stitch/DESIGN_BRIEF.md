...
- Clear Claim Panel turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called Clear Claim Panel. It should show three small status tiles, a Refresh button, and persist the selected tile in local state. Keep it simple.
...
- Status Utility - Clear Claim Panel

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Status Utility - Clear Claim Panel
